...
export const dayTimetableTableStrings = {
  ...
  remarkPlaceholder: "Notes for this day only (auto-saved)",
  permanentRemarkLabel: "Permanent note",
  permanentRemarkHint: "Shows on every day until you change it.",
  permanentRemarkPlaceholder: "e.g. allergy, parent preference…",
  todayRemarkLabel: "Today only",
  todayRemarkHint: "Only for this timetable date.",
