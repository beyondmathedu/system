...
export const dayTimetableTableStrings = {
  zh: {
    ...
    remarkHoverHint: "滑過姓名顯示，學生看不到",
    remarkBlurb: "備註：滑過姓名，在姓名旁彈出（年級／考試日期欄不顯示）。",
    lessonSummaryLabel: "課堂摘要",
    remarkClickOpen: "點擊查看",
    remarkHasNote: "有備註",
    remarkClose: "收起",
    saving: "儲存中...",
    autoSaved: "已自動儲存",
  ...
  en: {
    ...
    remarkBlurb:
      " Remarks: hover a name — panel opens beside the name (not shown in Grade / Exam columns).",
...
export const dayTimetableStyleEditorStrings = {
  zh: {
    ...
    extraBg: "加堂底色",
    feeUnpaid: "當月未繳且回看期只得 1 個月未繳 — 左色帶",
    feeArrears: "當月未繳且回看期至少 2 個月未繳 — 左色帶",
    lookback: "學費回溯月數（含當月）",
    lookbackHint: "2–24",
    threshold: "多月未繳門檻",
