/**
 * 批量新增 2026-05-01 生效的星期六 10:00 课表记录（追加，不覆盖）。
 */
...
const GROUPS = [
  {
    room: "Hope 1",
    students: [
      { nameZh: "徐洛悠", nick: "Ashley" },
      { nameZh: "黃頌恩", nick: "Grace" },
      { nameZh: "孫梓渝", nick: "Hazel" },
    ],
  },
  {
    room: "B",
    students: [
      { nameZh: "張卓瀅", nick: "Stephanie" },
      { nameZh: "王梓樂", nick: "Eric" },
    ],
  },
  {
    room: "M前",
    students: [
      { nameZh: "吳詠蕎", nick: "Mavis" },
      { nameZh: "蔡鴻耀", nick: "Henry" },
      { nameZh: "李伊庭", nick: "Serena" },
      { nameZh: "黃永晴", nick: "Kaylee" },
      { nameZh: "黃海晴", nick: "Karina" },
    ],
  },
];
...
for (const group of GROUPS) {
  for (const spec of group.students) {
    ...
    const newRec = {
      id: `bulk-20260501-sat1000-${student.id}-${++seq}`,
