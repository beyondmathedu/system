/**
 * 批量新增 2026-05-01 生效的星期六 11:30 课表记录（追加，不覆盖）。
 */
...
const GROUPS = [
  {
    ...
    students: [
      { nameZh: "岑朗澄" },
      { nameZh: "譚皓然" },
      { nameZh: "梁明慧", nick: "Kitty" },
      { nameZh: "鄺念祈", nick: "Niki" },
    ],
  },
  {
    room: "B",
    students: [
      { nameZh: "陳芷柔", nick: "Jobie" },
      { nameZh: "潘穎程", nick: "Vincy" },
      { nameZh: "周詠渝" },
      { nameZh: "陳潼橦", nick: "Annie" },
      { nameZh: "姜心悅", nick: "Cathy" },
    ],
  },
  {
    room: "M前",
    students: [
      { nameZh: "陳賜聰", nick: "Ian" },
      { nameZh: "何卓蕎", nick: "Pansy" },
      { nameZh: "王偉霖", nick: "William" },
      { nameZh: "李偉榮", nick: "Darren" },
      { nameZh: "曾熙融", nick: "Praotes" },
    ],
  },
];
...
for (const group of GROUPS) {
  for (const spec of group.students) {
    ...
    const newRec = {
      id: `bulk-20260501-sat1130-${student.id}-${++seq}`,
