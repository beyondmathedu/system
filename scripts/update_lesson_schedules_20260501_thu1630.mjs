/**
 * 批量新增 2026-05-01 生效的星期四 4:30 课表记录（追加，不覆盖）。
 */
...
const GROUPS = [
  {
    room: "Hope 1",
    students: [{ nameZh: "余嘉錡", nick: "Ashley" }],
  },
  {
    room: "B",
    students: [
      { nameZh: "劉見賢", nick: "Axel" },
      { nameZh: "黃韋舒", nick: "Tobias" },
      { nameZh: "黃梓沛", nick: "Vivian" },
    ],
  },
  {
    room: "M前",
    students: [
      { nameZh: "曹嘉兒", nick: "Kelly" },
      { nameZh: "張立謙", nick: "Terrance" },
      { nameZh: "李悠加", nick: "Yuka" },
      { nameZh: "梁芷瑜", nick: "Yubi" },
    ],
  },
];
...
for (const group of GROUPS) {
  for (const spec of group.students) {
    ...
    const newRec = {
      id: `bulk-20260501-thu1630-${student.id}-${++seq}`,
